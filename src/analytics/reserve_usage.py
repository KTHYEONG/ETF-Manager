"""Reporting-only reserve usage reconstruction for the locked QQQ path."""
...
def compare_qqq_reserve(
    *,
    ...
    """Run locked QQQ twice per window on identical cashflows: no reserve versus capped withhold.
