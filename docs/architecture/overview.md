...
flowchart LR
    ...
    subgraph OutOfScope["의도적 제외 범위 (Out-of-Scope)"]
        ...
        SR["위험 회피·비중 조정 목적의 매도 (연말 공제 활용 이익실현 TGH는 허용, ADR-007)"]
...
* **위험 회피·비중 조정·종목 교체 목적의 매도:** 수행하지 않습니다. 허용되는 매도는 매년 12월 250만 원 공제 한도 안에서 이익을 실현하고 즉시 재매수하는 세금 최적화(TGH, ADR-007)뿐입니다.
